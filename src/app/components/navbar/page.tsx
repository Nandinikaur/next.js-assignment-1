...
const Navbar = () => {
    return(
      <header className="flex w-[100%] h-[80px] justify-between gap-[40px] bg-slate-950"> 
        <h1 className="flex w-[200px] h-[80px] text-[35px] font-bold text-center items-center justify-center text-white">Tech World</h1>
          <nav className="flex w-[1400px] font-medium text-[25px] items-center justify-between">
    ...
    <Link className="text-[#cbc7c7] hover:text-[#ffffff]" href="../components/error">Error</Link>
 <Link className="text-[#cbc7c7] hover:text-[#ffffff]" href="../components/loading">Loading</Link>
 <Link className="text-[#cbc7c7] hover:text-[#ffffff]" href="../components/not-found">NotFound</Link>
